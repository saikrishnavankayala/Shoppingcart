    ...
    {  
        public static void main(String args[])   
            {  
                ...
                System.out.println("\t\t\t\t\t "+"  "+"Sai Srinivasa Grocery Shop");  
                System.out.println("\t\t\t\t\t7-142,main road,Chebrolu,Eluru District,Andhra Pradesh");  
                System.out.println("\t\t\t\t\t"  +"    " +"Opposite Patanjali Stores");  
                System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+91) 6300260522");  
